    ...
    return (
        <TProvider>
            ...
            <div className=" h-dvh flex justify-center px-1 md:px-5 ">
                <div className="mt-20 flex flex-col max-h-max w-full max-w-[500px]  md:max-h-[600]">
                    <div className="flex flex-row gap-2 mb-2 text-gray-500 cursor-pointer align-middle" onClick={() => navigate('/')}>
                        <ArrowLeftCircleIcon className="h-6 w-6 stroke-2" /> <span>Back</span>
                    </div>
                    <div className=" bg-white border border-stone-200 rounded-2xl">
                        <div className="bg-slate-200 p-2 text-black rounded-t-xl flex gap-2 align-middle items-center">
                        ...
                        <div className="mt-3 mx-3 pb-3 flex flex-col">
                            ...
                            <input
                                type="text"
                                className="mt-2 max-w-[400px] shoadow border border-slate-200 text-sm rounded w-full py-2 px-3 text-gray-700
                            leading-flight 
                            "
                            />
                        </div>
                        ...
                        <div className="mt-3 mx-2 pb-3 flex flex-col">
                            ...
                            <input
                                type="password"
                                className="mt-2 shoadow max-w-[400px] border border-slate-200 text-sm w-full py-2 px-3 text-gray-700
                        ...
                        <div className="px-3 mt-8">
                            <div className="flex flex-row gap-2 items-centermb-3">
                                <button className="px-3 py-2 text-sm bg-indigo-500 hover:bg-indigo-800 text-gray-100 rounded-sm shadow hover:shadow-md cursor-pointer transition duration-300">
                                    Login
                                </button>
